...
$select = array('id', 'username', 'email', 'IGN', 'name','status');
...
if ($search_string)
{
    ...
    $db->orwhere('username', '%' . $search_string . '%', 'like');
}
    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_user.php?operation=create">
	            	<button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add NEW User </button>
	            </a>
            </div>
        </div>
    </div>
            ...
            <?php foreach ($users as $row) : ?>
                <tr>
	                <td><?php echo $row['id'] ?></td>
                        <td style="text-align: center;padding: 15px;"><?php echo $row['status'] != 0 ? "<a id=\"greenb\">Active</a>" : "<a id=\"redb\">Inactive</a>" ?></td>
	                <td><?php echo $row['username'] ?></td>
	                <td><?php echo $row['IGN'] ?></td>
	                <td><?php echo $row['email'] ?> </td>
                  <td><?php echo $row['name'] ?> </td>
	                <td>
					<a href="edit_user.php?user_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
