...
$legends = $db->arraybuilder()->paginate("legend", $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Legends List</h1>
        </div>
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_legend.php?operation=create">
	            	<button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add NEW legend </button>
	            </a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            <?php foreach ($legends as $row) : ?>
                <tr>
	                ...
	                <td>
					<a href="edit_legend.php?legend_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
					...
					<a href=""  class="btn btn-danger delete_btn" data-toggle="modal" data-target="#confirm-delete-<?php echo $row['id'] ?>" style="margin-right: 8px;"><span class="glyphicon glyphicon-trash"></span></td>
					 ...
					 <div class="modal fade" id="confirm-delete-<?php echo $row['id'] ?>" role="dialog">
					    <div class="modal-dialog">
					      <form action="delete_legend.php" method="POST">
					      <!-- Modal content-->
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          ...
						          <p>Are you sure you want to delete this legend?</p>
						        </div>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="legends.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
