...
$weapons = $db->arraybuilder()->paginate("weapon", $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Weapons List</h1>
        </div>
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_weapon.php?operation=create">
	            	<button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add NEW Weapon </button>
	            </a>
            </div>
        </div>
    </div>
...
<!--   Filter section end-->
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            <?php foreach ($weapons as $row) : ?>
                <tr>
	                <td><?php echo $row['id'] ?></td>
	                <td><?php echo $row['name'] ?></td>
	                <td><?php echo $row['class'] ?></td>
	                <td>
					<a href="edit_weapon.php?weapon_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="weapons.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
